...
setTimeout(function () {
        describe("authenticate api test---------", function () {
            ...
            /*it("auth success: POST /authenticate", function (done) {
                chai.request(server)
                .post('/authenticate')
                .send({username: 'hasan', password: '123'})
                .end(function (err, res) {
                    res.should.have.status(200);
                    res.should.be.json;
                    res.body.should.be.a('object');
        ...
        describe("roles api test----------", function () {
            it("POST /roles", function (done) {
                chai.request(server)
                .post('/roles')
                .query({ token: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..QO3eZNvvDT__8Gr3yY0EmEOutocxiSrPHtoUkyX5bhQ' })
